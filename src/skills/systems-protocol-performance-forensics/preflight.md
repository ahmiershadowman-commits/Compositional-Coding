# systems-protocol-performance-forensics preflight
...
- Required context lanes: active_task, metacognitive_state, artifact_state
- Validation tags required: trace-reproduction, before-after-metrics, protocol-conformance
